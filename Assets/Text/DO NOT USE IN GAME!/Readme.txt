...
{Character name}|{Dialogue text}|{Character animation}
...
INPUT|{option text}={score increment}={start at line}={end at line}={jump to line}|{option text}={score increment}={start at line}={end at line}={jump to line}|{option text}={score increment}={start at line}={end at line}={jump to line}|{option text}={score increment}={start at line}={end at line}={jump to line}
...
* For each of the fours options:
  ...
  {score increment}: The number of points given/taken away from the player when the option is selected.
